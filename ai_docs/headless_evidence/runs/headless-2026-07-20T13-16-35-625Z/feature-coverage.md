...
Run ID: `headless-2026-07-20T13-16-35-625Z`
Trace ID: `da9b08b5-76a7-4137-b9e3-55e55e971315`
Commit: `850b04c3814af1a948103dde39c28090ec0af388`
Generated: 2026-07-20T13:17:13.611Z
...
- Passed checks: 12
- Failed checks: 0
- Trace: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/trace.jsonl`
...
| `subagent_worktree_isolation` | PASS | Subagent fallback and writer isolation policy | `extension-headless-flow` PASS<br>`workload-benchmark` PASS<br>`shard-merge-back-gate` PASS<br>`claude-parity-scorecard` PASS |
| `evaluator_gating` | PASS | External evaluator-only completion gate | `smoke-tests` PASS<br>`workload-benchmark` PASS<br>`shard-merge-back-gate` PASS<br>`claude-parity-scorecard` PASS |
| `approval_flows` | PASS | Explicit cyber approval request/resolve flow | `prod-security-review-readonly` PASS<br>`extension-headless-flow` PASS<br>`workload-benchmark` PASS<br>`claude-parity-scorecard` PASS |
...
| `resumability` | PASS | Session/disk replay and status restore | `smoke-tests` PASS<br>`workload-benchmark` PASS<br>`shard-merge-back-gate` PASS<br>`claude-parity-scorecard` PASS |
| `compaction_recovery` | PASS | Append-entry and latest state recovery surfaces | `smoke-tests` PASS<br>`workload-benchmark` PASS<br>`shard-merge-back-gate` PASS<br>`claude-parity-scorecard` PASS |
...
| `aws_integration` | PASS | AWS profile/account/region policy and Secrets Manager metadata handling | `smoke-tests` PASS<br>`aws-secret-metadata` PASS<br>`prod-security-review-readonly` PASS<br>`extension-headless-flow` PASS<br>`workload-benchmark` PASS<br>`claude-parity-scorecard` PASS |
...
| `sandboxing` | PASS | Sandbox/capability policy fail-closed behavior | `smoke-tests` PASS<br>`prod-security-review-readonly` PASS<br>`workload-benchmark` PASS<br>`vulnerability-remediation-workload` PASS<br>`claude-parity-scorecard` PASS |
...
| `tracing` | PASS | Trace/evaluation logging equivalent to Langfuse for local runs | `prod-security-review-readonly` PASS<br>`extension-headless-flow` PASS<br>`workload-benchmark` PASS<br>`vulnerability-remediation-workload` PASS<br>`local-trace-artifact` PASS<br>`derived-tracing` PASS<br>`claude-parity-scorecard` PASS |
...
| `continuous_readonly_prod_review` | PASS | Continuous read-only third-party production security review loop | `prod-security-review-readonly` PASS |
| `shard_merge_back` | PASS | Shard fan-out merge-back onto an integration branch, repair loop, and judge independence (deployment plan §6.6/§7.3, Campaign 4) | `shard-merge-back-gate` PASS |
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/build.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/smoke-tests.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/zai-live-probe.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/aws-secret-metadata.json`

### prod-security-review-readonly

Status: PASS

Third-party production security handoff runs as a bounded read-only review iteration

Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/prod-security-review-readonly.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/extension-headless-flow.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/workload-benchmark.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/vulnerability-remediation-workload.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/self-capability-comparator.json`

### shard-merge-back-gate

Status: PASS

C4 merge-back: 2-shard fan-out merges through the three-part gate, conflict returns to claimed with failure evidence, scoped crash recovery incl. kill -9, ledgered patches re-drive after crash, judge independence is configuration, merge events hash-chain and replay

Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/shard-merge-back-gate.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/local-trace-artifact.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-07-20T13-16-35-625Z/claude-parity-scorecard.json`
