...
Run ID: `headless-2026-06-29T12-25-45-738Z`
Trace ID: `c0052800-7ea5-45cc-9cee-fbc218478f56`
Commit: `6f4a2aff388ae63de8b34b257ad985090b5b2698`
Generated: 2026-06-29T12:27:44.045Z
...
- Passed checks: 12
- Failed checks: 0
- Trace: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/trace.jsonl`
...
| `signing_attestation` | PASS | Signed evidence attestations | `smoke-tests` PASS<br>`extension-headless-flow` PASS<br>`workload-benchmark` PASS<br>`vulnerability-remediation-workload` PASS<br>`headless-evidence-attestation` PASS<br>`claude-parity-scorecard` PASS |
...
| `tracing` | PASS | Trace/evaluation logging equivalent to Langfuse for local runs | `prod-security-review-readonly` PASS<br>`extension-headless-flow` PASS<br>`workload-benchmark` PASS<br>`vulnerability-remediation-workload` PASS<br>`local-trace-artifact` PASS<br>`headless-evidence-attestation` PASS<br>`derived-tracing` PASS<br>`claude-parity-scorecard` PASS |
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/build.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/smoke-tests.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/zai-live-probe.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/aws-secret-metadata.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/prod-security-review-readonly.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/extension-headless-flow.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/workload-benchmark.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/vulnerability-remediation-workload.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/self-capability-comparator.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/local-trace-artifact.json`

### headless-evidence-attestation

Status: PASS

Headless evidence manifest is signed and signature verification rejects tampering

Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/headless-evidence-attestation.json`
...
Artifact: `ai_docs/headless_evidence/runs/headless-2026-06-29T12-25-45-738Z/claude-parity-scorecard.json`
