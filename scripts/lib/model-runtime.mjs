...
export const EXPECTED_PROFILES = Object.freeze({
  ...
  fireworks_kimi_k3: ["fireworks", "accounts/fireworks/models/kimi-k3", "FIREWORKS_API_KEY"],
  fireworks_kimi_k3_fast: ["fireworks", "accounts/fireworks/routers/kimi-k3-fast", "FIREWORKS_API_KEY"],
  fireworks_deepseek_v4_flash: ["fireworks", "accounts/fireworks/models/deepseek-v4-flash-0731", "FIREWORKS_API_KEY"],
