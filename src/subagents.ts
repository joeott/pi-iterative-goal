        ...
        content: [
          {
            ...
            text: [
              ...
              invocationHint,
              "",
              "TIMEOUT: Subagent must return within 5 minutes. If no response, cancel and fall back to single-agent scouting.",
              "Do NOT delegate operations known to be harness-blocked (e.g., git writes) to subagents.",
              "",
