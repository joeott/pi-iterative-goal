...
export const MODEL_PROFILE_ENDPOINTS: Readonly<Record<ModelProfileId, {
  ...
  fireworks_kimi_k3: { provider: "fireworks", model: "accounts/fireworks/models/kimi-k3", familyId: "moonshotai/kimi-k3" },
  fireworks_kimi_k3_fast: { provider: "fireworks", model: "accounts/fireworks/routers/kimi-k3-fast", familyId: "moonshotai/kimi-k3" },
  fireworks_deepseek_v4_flash: { provider: "fireworks", model: "accounts/fireworks/models/deepseek-v4-flash-0731", familyId: "deepseek/deepseek-v4-flash" },
